...
public class A_EntityManagerLifeCycleTests {
    /*
    * 엔티티 매니저 팩토리(EntityManagerFactory)란? // db와 연결?
    ...
    * */
    ...
    /*
    * 엔티티 매니저(Entity Manager)란? // 메모리 상에 관리되는 메모리
    * 엔티티 매니저는 엔티티를 저장하는 메모리 상의 데이터베이스를 관리하는 인스턴스이다
    * 엔티티를 저장하고 수정, 삭제, 조회히는 등의 엔티티와 관련된 모든 일을 한다
    ...
    * 영속성 컨텍스트는 엔티티를 key-value 방식으로 저장하는 관리소이다
