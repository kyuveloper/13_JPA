...
public class ProjectionTests {
    ...
    * */
    ...
    void 단일_엔티티_프로젝션_테스트() {
        // when
        String jpql = "SELECT m FROM menu_section03 as m";
    ...
    void 양방향_연관관계_엔티티_프로젝션_테스트() {
        ...
        // when
        String jpql = "SELECT m.category FROM bidirection_menu as m WHERE m.menuCode = :menuCode";
    ...
    void 임베디드_타입_프로젝션_테스트() {
        ...
        // when
        String jpql = "SELECT m.menuInfo FROM embedded_menu as m";
    ...
    void TypedQuery를_이용한_스칼라_타입_프로젝션_테스트() {
        // when
        String jpql = "SELECT c.categoryName FROM category_section03 as c";
    ...
    * 그 때, TypeQuery 대신 Query를 사용하여 Object[]로 행의 정보를 반환 받아 사용한다.
    * */
    @Test
