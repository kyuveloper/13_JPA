...
public class ParameterBindingTests {
    ...
    * 2, 위치 기준 파라미터 (position parameters)
    ...
    * */
    ...
    void 이름_기준_파라미터_바인딩_메뉴_목록_조회_테스트() {
        ...
        // when
        String jpql = "SELECT m FROM menu_section02 as m WHERE m.menuName = :menuName";
    ...
    void 위치_기준_파라미터_바인딩_메뉴_목록_조회_테스트() {
        ...
        // when
        String jpql = "SELECT m FROM menu_section02 as m WHERE m.menuName = ?1";
